...
const completionObj = [
  ...
  { text: 'cancel', bg: 'rgba(239, 128, 147, 0.4)', color: 'redOne' },
  { text: 'paid', bg: 'rgba(75, 222, 151, 0.2)', color: 'greenOne' },
  { text: 'pending', bg: '#FFF4CA', color: '#BE9800' },
  { text: 'completed', bg: 'rgba(75, 222, 151, 0.2)', color: 'greenOne' },
];

const PensionTableItem = ({ value }: Props) => {
  const valueData = completionObj.find(
